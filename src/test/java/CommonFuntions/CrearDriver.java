...
public class CrearDriver {
    ...
    //Se crea el constructor de la clase donde se inicia la configuracion
    private CrearDriver() {
        CrearDriver.inicialConfig();
    }

    //Esta configuracion toma el Sistema operativo y el navegador del archivo .properties y crea el driver
